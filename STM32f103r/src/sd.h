...
//#include "usart1.h"
/* Includes ------------------------------------------------------------------*/
#define SD_CD (GPIOE->IDR & GPIO_Pin_6)
...
//#define SDIO_TRANSFER_CLK_DIV            ((uint8_t)0x02)      //18MHz
//#define SDIO_TRANSFER_CLK_DIV            ((uint8_t)0x02) //2MHz
#define SDIO_TRANSFER_CLK_DIV            ((uint8_t)0x22)  //2MHz
