...
typedef struct {
  ...
  float bed_ForCalulate_point_x,bed_ForCalulate_point_y,bed_ForCalulate_point_z;
  s32 position_block[4];
...
static void Axis_go_origin(u8 axis,u8 dir, u16 speed, u8 home, float origin_coordinate );
