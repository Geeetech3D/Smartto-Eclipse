#ifndef __Configuration_GTM32_Pro_A30S_H__  
#define __Configuration_GTM32_Pro_A30S_H__
#include "Configuration_Select_Printer.h"


#define DEVICE_NAME "GEEETECH-A30S"     //Device name
#define MACHINE_TYPE "A30S"                   //Equipment model
